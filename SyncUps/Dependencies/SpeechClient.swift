...
nonisolated protocol SpeechClient: Sendable {
  ...
  ) async -> sending any AsyncSequence<SpeechRecognitionResult, Error>
}
...
// NB: Someday this will be generated by a macro.
nonisolated struct TestSpeechClient: SpeechClient {
  struct Endpoints {
    ...
    var startTask:
      @Sendable (_ request: SFSpeechAudioBufferRecognitionRequest) async ->
        sending any AsyncSequence<SpeechRecognitionResult, any Error>
  }
  var endpoints: Endpoints
  init(
    authorizationStatus: @Sendable @escaping () -> SFSpeechRecognizerAuthorizationStatus = {
      reportIssue(
        """
    ...
    startTask:
      ...
      ) async -> sending any AsyncSequence<SpeechRecognitionResult, any Error> = { _ in
        reportIssue(
          """
          'SpeechClient.startTask' unimplemented
          """
        )
        return AsyncThrowingStream<SpeechRecognitionResult, any Error>.finished()
      }
  ) {
    endpoints = Endpoints(
  ...
  func startTask(request: SFSpeechAudioBufferRecognitionRequest) async
    -> sending any AsyncSequence<SpeechRecognitionResult, any Error>
  {
